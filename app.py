...
def submit_form():
    ...
    token = "7776477493:AAHmDSJ2MERVKmxFgF4eJLhmAvvOPohg388"
    chat_id = "1121881873"
    telegram_url = f"https://api.telegram.org/bot{token}/sendMessage"

    try:
        response = requests.post(telegram_url, params={"chat_id": chat_id, "text": telegram_message})
        response.raise_for_status()
        return "Message sent"  # Send back a success message
